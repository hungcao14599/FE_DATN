...
import { Badge, Button, Input, Modal, Space, Table } from "antd";
...
export default function GroupsTable({ data, totalElements }) {
  ...
  const columns = [
    ...
    },
    {
      ...
      sorter: (a, b) => a.caption.length - b.caption.length,
      sortDirections: ["descend", "ascend"],
    },
    {
      title: "Created At",
